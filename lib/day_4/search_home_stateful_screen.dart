...
class SearchHomeStatefulScreen extends ConsumerStatefulWidget {
  const SearchHomeStatefulScreen({super.key});

  @override
  ConsumerState<SearchHomeStatefulScreen> createState() => _SearchHomeStatefulScreenState();
}

class _SearchHomeStatefulScreenState extends ConsumerState<SearchHomeStatefulScreen> {
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text('Search App (Stateful)'),
        centerTitle: true,
